...
//       search: searchVal,
//       limit: rowsPerPage,  // Add this
//       offset: 0             // Add this (start from page 1)
//     });
//     setLaborTypes(response.data || []); // Use response.data
//     setIsSearchActive(true);
//     setTotalLaborTypes(response.total || 0); // Use response.total
//     setCurrentPage(1);
//   } catch (error) {
//     console.log(error);
...
//         <LaborTypeTable
//           data={laborTypes}
//           onEdit={(id) => navigate(`/edit-labor-type/${id}`)}
//           onDelete={(id) =>
